...
function MobileSandbox({ iv, play, field }) {
  ...
  // height:100% (not flex:1) — IvWorkbench is a plain block, so flex:1 collapsed to
  // content height and overflow:auto had nothing to bound against, leaving the page
  // unscrollable. Filling the parent's bounded box lets overflow:auto scroll.
  return (
    <div style={{ height: '100%', minHeight: 0, overflow: 'auto', background: CC.bg }}>
