...
const FORCES_M = [
  ...
  { name: 'Backfire', rule: 'BacklashRepulsion', tag: 'L',
    ...
    cite: 'Jager & Amblard 2005 (model form); Bail et al. 2018 (empirical, contested — did not replicate in Guess & Coppock 2020)' },
  { name: 'Homophily', rule: 'TieRewiring', tag: 'L',
    ...
    cite: 'McPherson, Smith-Lovin & Cook 2001; Holme & Newman 2006 (network coevolution)' },
  { name: 'Party pull', rule: 'PartyPull', tag: 'L',
    ...
    cite: 'Zaller 1992; Levendusky 2009 (elite cues / partisan sorting)' },
...
const MACHINERY = [
  { name: 'Activist → elite → mass loop', tag: 'N', rule: 'activist_elite',
    body: 'The endogenous source of party sorting. A party’s activists pull its elite outward, the elite cue pulls the rank-and-file, and the party’s own sorting feeds its next round of mobilization — a spiral. This is why the party positions emerge instead of being read in from data (Bawn et al. 2012; Zaller 1992).' },
  { name: '7-issue substrate + emergent constraint', tag: 'N', rule: 'ConstraintOp',
    body: 'Under the hood each agent holds seven correlated issue positions, not two. How tightly those issues bundle into a single left–right axis (“constraint”) emerges from influence rather than being imposed; the 2-axis compass you see is a readout of that richer state (DellaPosta 2020; Baldassarri & Gelman 2008).' },
  ...
  { name: 'Cohort replacement', tag: 'L', rule: 'cohort_replacement',
    body: 'Generational turnover: each tick a sliver of the oldest agents is retired and replaced by younger ones drawn from the current climate, so the population slowly refreshes over the 45 years (Ghitza, Gelman & Auerbach 2023).' },
  ...
  { name: 'Friedkin–Johnsen anchoring', tag: 'N', rule: 'FJ anchor + stubbornness',
    body: 'Every ideology-moving step is damped by (1 − stubbornness), and each agent feels a small pull back toward its fixed starting anchor. A stubborn majority barely moves; it keeps the system from collapsing to a single point (Friedkin & Johnsen 1990).' },
...
const SOURCES = [
  ...
  ['Mechanisms', 'Hegselmann & Krause 2002; Deffuant et al. 2000 (bounded confidence) · Jager & Amblard 2005; Bail et al. 2018; Guess & Coppock 2020 (repulsion / backfire, contested) · McPherson, Smith-Lovin & Cook 2001; Holme & Newman 2006 (homophily) · Friedkin & Johnsen 1990 (anchoring) · Iyengar, Sood & Lelkes 2012 (affect) · Mason 2018 (identity) · Bawn et al. 2012; Zaller 1992 (activist→elite loop) · DellaPosta 2020; Baldassarri & Gelman 2008 (issue constraint) · Ghitza, Gelman & Auerbach 2023 (cohort replacement)'],
