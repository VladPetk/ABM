...
const IV_TAKE = {
  ...
  X2_fix_algorithm: 'The classic scapegoat of the social media era - the algorithm. The logic is simple - algorithms maximize engagement. And engagement comes from extreme, polarizing, enraging content. So turn your feed off. Alas, in the model, as in research studies, almost nothing happens. The divide was never mainly the feed’s doing.',
  ...
  X4_bipartisan_dialogue: 'Structured, facilitated conversations between the two sides — the kind that genuinely helps the people in the room. The catch is reach: only a sliver of the country ever sits in such a room, so the split hardly budges at the national level.',
