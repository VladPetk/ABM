...
const STORY_BEATS = [
  {
    ...
    body: 'These are the same forces you watched stall a moment ago: their strengths were fit to decades of ANES survey data — where Americans actually stood, and how cold they’d grown toward the other side. What the previous section switched off, and this one switches back on, is the history: the real drivers fed in on top of the mechanism — the spread of partisan media across the period, and the dated events that shaped it, from Fox News to the Tea Party to 2016 to COVID and January 6th. That’s what carries the engine the rest of the way, onto the actual 1980-2025 timeline. From here you’re watching a reconstruction of the United States, and we’ll stop at the moments that moved it.',
  },
  {
    tick: 42, title: 'The leaders break first', short: 'Elite drift', layer: 'position',
    lead: 'The split begins at the top — politicians set the pace.',
    body: (<>For more than a decade after 1980, the parties hardly move. Then the elites start to pull apart, the sharpest turn coming with Newt Gingrich’s 1994 takeover. And the Republican side moved right faster than the Democrats moved left. Among everything in this story, the <em>direction</em> and <em>timing</em> of this elite drift carry the strongest evidence as a cause of accelerated polarization. Note that the voters don’t so much radicalize as <strong>sort</strong>: they don’t necessarily move more toward the edges of the compass, rather they cluster tighter around their parties.</>),
  ...
  },
  {
    ...
    body: 'Blaming social media for societal ills is as old as social media itself. But what does the data actually say? Consider that affective polarization rose fastest among the oldest, least-online Americans. Quite the opposite of what we’d expect from social-media-driven dynamics. To top that off, experimental studies find no significant results for this hypothesis either. Could the feed still matter in ways those studies don’t catch? Perhaps. But here it looks like a weak and contested accelerant at most, and nowhere near the cause.',
  ...
  },
  {
    ...
    lead: 'By the pandemic, the two camps hardly touch on the map.',
