...
All three take ``agents`` and ``network`` (the
``dict[int, set[int]]`` from ``env.attrs["network"]``) and aggregate
party affiliation across the edges. They are the headline measures
that Phase 3 S4 is supposed to move.
