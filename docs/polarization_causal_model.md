...
| **Media as amplifier on already-sorted agents** (L5) | `media_consumption` (homophilous diet), `media_shock` | **Right pattern** (selective exposure). But the **2008/2012 social-media events are coded as a real affect shock** — stronger than evidence supports. Make social-media affect forcing **small / off-by-default / tunable**; keep cable (Fox 1996) as the real amplifier. |
