...
| **IdentitySorting** (Mason mega-identity) | **L** | Mason 2018 *Uncivil Agreement*. Reproduces the qualitative mega-identity-stacking story. Inert in the default pillar (sort_rate = 0); available as an optional intensifier. |
